...
Canonical source for the Hell Harbor Entertainment website.

## Content ownership

- `app/content/brand-registry.ts` owns shared public facts used across the HHE experience.
- Hell Harbor owns company structure, services, commerce, events, and corporate contact routing.
- Dab & Stab Records owns roster, alumni, discography, and music-production credits.
- JesterTheRyda owns the artist biography, personal music presentation, streaming, lore, and EPK.
